...
const Navbar = () => {
    ...
    const MenuBar = <>
        <Link className='btn btn-ghost font-serif btn-sm font-bold text-white ' to="/" ></Link>
        <Link id="skill" htmlFor='skill' className='btn btn-ghost font-serif btn-sm font-bold text-white' >skill</Link>
