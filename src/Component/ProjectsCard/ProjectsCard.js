                ...
                <div className="grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
                    ...
                    >
                        ...
                        <div className={`group p-2 absolute left-4 bottom-4 bg-white/20 backdrop-blur-md w-11/12 rounded-md  hover:duration-300 ease-in-out hover:h-[50%] hover:w-[100%] overflow-hidden hover:left-0 hover:bottom-0 `}>
                            ...
                            <p className={`text-lg text-para hidden group-hover:block text-black `}>This is a second mobile selling site where second mobiles can be bought and sold.</p>
                    ...
                    >
                        ...
                        <div className={`group p-2 absolute left-4 bottom-4 bg-white/20 backdrop-blur-md w-11/12 rounded-md  hover:duration-300 ease-in-out hover:h-[50%] hover:w-[100%] overflow-hidden hover:left-0 hover:bottom-0 `}>
                            ...
                            <p className={`text-lg text-para hidden group-hover:block text-black `}>This is a world photography site where you can enter the site and give reviews by looking at the pictures.</p>
                            <div className="mt-4 hidden group-hover:flex flex-wrap items-center justify-start gap-4 mx-auto expertise  cursor-pointer">
                    ...
                    >
                        ...
                        <div className={`group p-2 absolute left-4 bottom-4 bg-white/20 backdrop-blur-md w-11/12 rounded-md  hover:duration-300 ease-in-out hover:h-[50%] hover:w-[100%] overflow-hidden hover:left-0 hover:bottom-0 `}>
                            ...
                            <p className={`text-lg text-para hidden group-hover:block  `}>Local Freelancing marketplace Easy sharing and getting service Local payment Method with ssl Commers. Realtime chating feature with socket.oi</p>
                            <div className="mt-4 hidden group-hover:flex flex-wrap items-center justify-start gap-4 mx-auto expertise  cursor-pointer">
